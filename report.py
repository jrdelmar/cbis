...
def report():
    ...
    #save the file 
    #indexPath = os.path.abspath(__file__)
    #save in the same folder as the prediction file 
    indexPath = os.path.dirname(os.path.abspath(pred_file))
    #print("prediction_file=",indexPath)

    save( [results],  indexPath, ["summary_predictions"])
