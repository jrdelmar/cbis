...
#from pyimagesearch.report import get_report_data
...
def search_predictions (pred_file, exif_file, search_list, top_k, threshold, verbose ):
    ...
    log("[INFO][FLASK] Starting to load prediction file {} and exif file {} ...".format(pred_file, exif_file),always_verbose)
    indexPath = os.path.dirname(__file__)
    s = Searcher(indexPath, verbose)
    _image_list = []
    _image_path_list = []
